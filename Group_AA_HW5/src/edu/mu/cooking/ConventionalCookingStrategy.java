...
public class ConventionalCookingStrategy implements ICookingStrategy  {

	public ConventionalCookingStrategy() {
	...
	public boolean cook(AbstractPizza pizza) {
		if(pizza != null)
		{
		pizza.setCookingPrice(8.0); //sets the price of the cooking to $10
